...
class NavBar extends Component {
    ...
    toggleMenu(){
        if(document.querySelector('.dropdown').classList[1] === undefined){
            ...
            if(window.location.href.includes('1stTime')){
                document.querySelector('.first-time').style.fill = '#d5001c'
                document.querySelector('.home').style.color = 'white'
                document.querySelector('.nine').style.fill = 'white'
                document.querySelector('.seven').style.fill = 'white'


            } else if (window.location.href === 'http://localhost:3000/#/'){
                document.querySelector('.home').style.color = '#d5001c'
                document.querySelector('.first-time').style.fill = 'white'
                document.querySelector('.nine').style.fill = 'white'
                document.querySelector('.seven').style.fill = 'white'


            } else if (window.location.href.includes('911')){
                document.querySelector('.nine').style.fill = '#d5001c'
                document.querySelector('.first-time').style.fill = 'white'
                document.querySelector('.home').style.color = 'white'
                document.querySelector('.seven').style.fill = 'white'

            } else if (window.location.href.includes('718')){
                document.querySelector('.seven').style.fill = '#d5001c'
                document.querySelector('.first-time').style.fill = 'white'
                document.querySelector('.home').style.color = 'white'
                document.querySelector('.nine').style.fill = 'white'
    ...
    handleNineElevenHover(){
        document.querySelector('.seven-eighteen').classList.remove('hovered-seven')
        document.querySelector('.nine-eleven').classList.add('hovered-nine')
        document.querySelector('.nine-carrera').classList.add('hovered-nine-for-carrera')
        document.querySelector('.nine-t').classList.add('hovered-nine-for-t')
        document.querySelector('.nine-gts').classList.add('hovered-nine-for-gts')
        document.querySelector('.nine-turbo').classList.add('hovered-nine-for-turbo')
        if(!window.location.href.includes('911')){
            document.querySelector('.nine').style.fill = '#d5001c'
    ...
    handleSevenEighteenHover(){
        document.querySelector('.nine-eleven').classList.remove('hovered-nine')
        document.querySelector('.seven-eighteen').classList.add('hovered-seven')
        document.querySelector('.seven-cayman').classList.add('hovered-seven-for-cayman')
        document.querySelector('.seven-cayman-gts').classList.add('hovered-seven-for-cayman-gts')
        document.querySelector('.seven-cayman-s').classList.add('hovered-seven-for-cayman-s')
        document.querySelector('.seven-boxster').classList.add('hovered-seven-for-boxster')
        document.querySelector('.seven-boxster-gts').classList.add('hovered-seven-for-boxster-gts')
        document.querySelector('.seven-boxster-s').classList.add('hovered-seven-for-boxster-s')

        if(!window.location.href.includes('718')){
            document.querySelector('.seven').style.fill = '#d5001c'
            ...
            <div className = "navbar-contain">
                ...
                <div className = "nav-section-edge right">
                    ...
                    <div className = "link1">
                        ...
                        <a target = "_blank" rel="noopener noreferrer" href = "https://www.porsche.com/usa/modelstart/">Build Your Own</a>
                    </div>
                    <div className = "link2">
                        <FaExternalLink className = "open-link external2"/>
                        <a target = "_blank" rel="noopener noreferrer" href = "https://www.porsche.com/usa/inventorysearch/">Search Inventory</a>
                    </div>
                    <div className = "link3">
                        <FaExternalLink className = "open-link external3"/>
                        <a target = "_blank" rel="noopener noreferrer" href = "https://www.porsche.com/usa/dealersearch/" className = "no-margin">Find a Dealer</a>
                    </div>
                ...
                <div className = "dropdown-cars-contain nine-eleven">
                    ...
                    <Link to = "/911/carrera"><div className = "car-section">
                        ...
                        <Link to = "/911/carrera-t"><div className = "car-section">
                            <a className = "nine-t" onClick = {() => this.handleRedirectClick()}>
                                <div className = "car-image"></div>
                                <div className = "gradient-border"></div>
                                <div className = "dropdown-car-name">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 224.8 313.4"><polygon fill="#d5001c" points="0,0 156.7,156.7 0,313.4 68.1,313.4 224.8,156.7 68.1,0 "></polygon></svg>
                        ...
                        <Link to = "/911/gts"><div className = "car-section">
                            <a className = "nine-gts" onClick = {() => this.handleRedirectClick()}>
                                <div className = "car-image"></div>
                                <div className = "gradient-border"></div>
                                <div className = "dropdown-car-name">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 224.8 313.4"><polygon fill="#d5001c" points="0,0 156.7,156.7 0,313.4 68.1,313.4 224.8,156.7 68.1,0 "></polygon></svg>
                        ...
                        <Link to = "/911/turbo"><div className = "car-section">
                            <a className = "nine-turbo" onClick = {() => this.handleRedirectClick()}>
                                <div className = "car-image"></div>
                                <div className = "gradient-border"></div>
                                <div className = "dropdown-car-name">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 224.8 313.4"><polygon fill="#d5001c" points="0,0 156.7,156.7 0,313.4 68.1,313.4 224.8,156.7 68.1,0 "></polygon></svg>
                ...
                <div className = "dropdown-cars-contain seven-eighteen">
                    <h2><span><b style = {{color: '#d5001c'}}>Time to</b></span><span><b style = {{color: 'white'}}>Find your 718.</b></span></h2>
                    <div className = "dropdown-cars">
                    <Link to = "/718/cayman"><div className = "car-section">
                            <a className = "seven-cayman" onClick = {() => this.handleRedirectClick()}>
                                <div className = "car-image"></div>
                                <div className = "gradient-border"></div>
                                <div className = "dropdown-car-name">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 224.8 313.4"><polygon fill="#d5001c" points="0,0 156.7,156.7 0,313.4 68.1,313.4 224.8,156.7 68.1,0 "></polygon></svg>
                        ...
                        <Link to = "/718/cayman-s"><div className = "car-section">
                            <a className = "seven-cayman-s" onClick = {() => this.handleRedirectClick()}>
                                <div className = "car-image"></div>
                                <div className = "gradient-border"></div>
                                <div className = "dropdown-car-name">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 224.8 313.4"><polygon fill="#d5001c" points="0,0 156.7,156.7 0,313.4 68.1,313.4 224.8,156.7 68.1,0 "></polygon></svg>
                        ...
                        <Link to = "/718/cayman-gts"><div className = "car-section">
                            <a className = "seven-cayman-gts" onClick = {() => this.handleRedirectClick()}>
                                <div className = "car-image"></div>
                                <div className = "gradient-border"></div>
                                <div className = "dropdown-car-name">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 224.8 313.4"><polygon fill="#d5001c" points="0,0 156.7,156.7 0,313.4 68.1,313.4 224.8,156.7 68.1,0 "></polygon></svg>
                        ...
                        <Link to = "/718/boxster"><div className = "car-section">
                            <a className = "seven-boxster" onClick = {() => this.handleRedirectClick()}>
                                <div className = "car-image"></div>
                                <div className = "gradient-border"></div>
                                <div className = "dropdown-car-name">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 224.8 313.4"><polygon fill="#d5001c" points="0,0 156.7,156.7 0,313.4 68.1,313.4 224.8,156.7 68.1,0 "></polygon></svg>
                        ...
                        <Link to = "/718/boxster-gts"><div className = "car-section">
                            <a className = "seven-boxster-gts" onClick = {() => this.handleRedirectClick()}>
                                <div className = "car-image"></div>
                                <div className = "gradient-border"></div>
                                <div className = "dropdown-car-name">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 224.8 313.4"><polygon fill="#d5001c" points="0,0 156.7,156.7 0,313.4 68.1,313.4 224.8,156.7 68.1,0 "></polygon></svg>
                        ...
                        <Link to = "/718/boxster-s"><div className = "car-section">
                            <a className = "seven-boxster-s" onClick = {() => this.handleRedirectClick()}>
                                <div className = "car-image"></div>
                                <div className = "gradient-border"></div>
                                <div className = "dropdown-car-name">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 224.8 313.4"><polygon fill="#d5001c" points="0,0 156.7,156.7 0,313.4 68.1,313.4 224.8,156.7 68.1,0 "></polygon></svg>
