...
class NavBar extends Component {
    ...
    componentDidMount(){
        if(window.location.href === 'http://localhost:3000/#/'){
            this.setState({
                homeStyle: {color: '#d5001c'},
                firstTimeColor: 'white'
            })
        } else if (window.location.href === 'http://localhost:3000/#/1stTime'){
            this.setState({
                firstTimeColor: '#d5001c',
